...
def import_ply():
    pcd_load=o3d.io.read_point_cloud('/home/gvc/Desktop/dev/PCN-PyTorch/data/PCNew/test_novel/partial/01267162/object_127.ply')
...
if __name__ == '__main__':
    ...
    downpcd.points=o3d.utility.Vector3dVector(result_numpy)
    o3d.io.write_point_cloud("/home/gvc/Desktop/dev/PCN-PyTorch/test.ply", downpcd, write_ascii=True)
